...
Monte-Carlo Markov Chain.(needs explanantion)

Non negative matrix factorization can be use for topic modeling and finding eigenfaces. It has the advantage of having meaningful outputs\cite{Lee1999}.

Non netative tensor factorization is a fuzzy clustering algorithm, it can handle  Sparse data\cite{Ho2014a}. The input data should be in tensor form.
